...
Run demo with
python3 -m interpolation.interpolator.statistical_interpolator interpolator/statistical_interpolator.py
"""
import statistics
import logging
...
def get_interpolation_results(temperature_distance_tuples, t_actual, postfix=""):
    """
    ...
    result = {
        "idw_p0.01" + postfix: calculate_square_error(inverted_distance_weight(temperatures, distances, .01)),
        "idw_p0.05" + postfix: calculate_square_error(inverted_distance_weight(temperatures, distances, .05)),
        "idw_p0.1" + postfix: calculate_square_error(inverted_distance_weight(temperatures, distances, .1)),
        "idw_p0.2" + postfix: calculate_square_error(inverted_distance_weight(temperatures, distances, .2)),
        "idw_p0.4" + postfix: calculate_square_error(inverted_distance_weight(temperatures, distances, .4)),
        "idw_p0.6" + postfix: calculate_square_error(inverted_distance_weight(temperatures, distances, .6)),
        "idw_p0.8" + postfix: calculate_square_error(inverted_distance_weight(temperatures, distances, .8)),
        ...
        "mean" + postfix: calculate_square_error(statistics.mean(temperatures))
    }
